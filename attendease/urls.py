...
from attendeaseapp.views import register, login_view, logout_view, teacherhome, studenthome, index, search_classes, class_detail, attendance, add_attendance, remove_attendance
